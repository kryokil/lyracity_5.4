...
// Begin ScriptStruct FCrowdPreset
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCrowdPreset, Name), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Name_MetaData), NewProp_Name_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_CharacterOptions = { "CharacterOptions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCrowdPreset, CharacterOptions), Z_Construct_UScriptStruct_FCrowdCharacterOptions, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CharacterOptions_MetaData), NewProp_CharacterOptions_MetaData) }; // 580004803
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::StructParams = {
...
UScriptStruct* Z_Construct_UScriptStruct_FCrowdPreset()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_CrowdPreset.InnerSingleton, Z_Construct_UScriptStruct_FCrowdPreset_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_CrowdPreset.InnerSingleton;
}
// End ScriptStruct FCrowdPreset

// Begin Class UCrowdPresetDataAsset
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets_Inner = { "Presets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FCrowdPreset, METADATA_PARAMS(0, nullptr) }; // 2638011455
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets = { "Presets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCrowdPresetDataAsset, Presets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Presets_MetaData), NewProp_Presets_MetaData) }; // 2638011455
...
// End Class UCrowdPresetDataAsset

// Begin ScriptStruct FCrowdVATPreset
...
struct Z_Construct_UScriptStruct_FCrowdVATPreset_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AnimToTextureAsset_MetaData[] = {
		{ "Category", "CrowdVATPreset" },
		{ "ModuleRelativePath", "Public/Crowd/CrowdPresetDataAsset.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AnimToTextureAsset;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static void* NewStructOps()
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewProp_AnimToTextureAsset = { "AnimToTextureAsset", nullptr, (EPropertyFlags)0x0114000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCrowdVATPreset, AnimToTextureAsset), Z_Construct_UClass_UAnimToTextureDataAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AnimToTextureAsset_MetaData), NewProp_AnimToTextureAsset_MetaData) };
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_CitySample,
...
UScriptStruct* Z_Construct_UScriptStruct_FCrowdVATPreset()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_CrowdVATPreset.InnerSingleton, Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_CrowdVATPreset.InnerSingleton;
}
// End ScriptStruct FCrowdVATPreset

// Begin Class UCrowdVATPresetDataAsset Function CopyFromCrowdPreset
...
// End Class UCrowdVATPresetDataAsset Function CopyFromCrowdPreset

// Begin Class UCrowdVATPresetDataAsset Function CopyToDataTable
...
// End Class UCrowdVATPresetDataAsset Function CopyToDataTable

// Begin Class UCrowdVATPresetDataAsset Function Randomize
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_FixedOptions = { "FixedOptions", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventRandomize_Parms, FixedOptions), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 514709346
...
// End Class UCrowdVATPresetDataAsset Function Randomize

// Begin Class UCrowdVATPresetDataAsset
...
struct Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset, "CopyFromCrowdPreset" }, // 1073379882
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable, "CopyToDataTable" }, // 935191671
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize, "Randomize" }, // 2185691908
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets_Inner = { "Presets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FCrowdVATPreset, METADATA_PARAMS(0, nullptr) }; // 341268360
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets = { "Presets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCrowdVATPresetDataAsset, Presets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Presets_MetaData), NewProp_Presets_MetaData) }; // 341268360
...
// End Class UCrowdVATPresetDataAsset

// Begin Registration
struct Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCrowdPreset::StaticStruct, Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewStructOps, TEXT("CrowdPreset"), &Z_Registration_Info_UScriptStruct_CrowdPreset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdPreset), 2638011455U) },
		{ FCrowdVATPreset::StaticStruct, Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewStructOps, TEXT("CrowdVATPreset"), &Z_Registration_Info_UScriptStruct_CrowdVATPreset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdVATPreset), 341268360U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCrowdPresetDataAsset, UCrowdPresetDataAsset::StaticClass, TEXT("UCrowdPresetDataAsset"), &Z_Registration_Info_UClass_UCrowdPresetDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCrowdPresetDataAsset), 2229295879U) },
		{ Z_Construct_UClass_UCrowdVATPresetDataAsset, UCrowdVATPresetDataAsset::StaticClass, TEXT("UCrowdVATPresetDataAsset"), &Z_Registration_Info_UClass_UCrowdVATPresetDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCrowdVATPresetDataAsset), 1985103868U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_1495267467(TEXT("/Script/CitySample"),
	Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Crowd_CrowdPresetDataAsset_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
