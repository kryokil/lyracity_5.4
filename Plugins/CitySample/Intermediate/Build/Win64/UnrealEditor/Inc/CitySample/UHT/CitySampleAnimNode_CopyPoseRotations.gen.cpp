...
// Begin ScriptStruct FCitySample_BoneSourceToTargetMapping
...
struct Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SourceBoneNames_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/Anim/CitySampleAnimNode_CopyPoseRotations.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIncludeFullTransform_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/Anim/CitySampleAnimNode_CopyPoseRotations.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIncludeInputPose_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/Anim/CitySampleAnimNode_CopyPoseRotations.h" },
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics::NewProp_TargetBoneName = { "TargetBoneName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCitySample_BoneSourceToTargetMapping, TargetBoneName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TargetBoneName_MetaData), NewProp_TargetBoneName_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics::NewProp_SourceBoneNames = { "SourceBoneNames", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCitySample_BoneSourceToTargetMapping, SourceBoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SourceBoneNames_MetaData), NewProp_SourceBoneNames_MetaData) };
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics::StructParams = {
...
UScriptStruct* Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_CitySample_BoneSourceToTargetMapping.InnerSingleton, Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_CitySample_BoneSourceToTargetMapping.InnerSingleton;
}
// End ScriptStruct FCitySample_BoneSourceToTargetMapping

// Begin ScriptStruct FCitySampleAnimNode_CopyPoseRotations
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCitySampleAnimNode_CopyPoseRotations_Statics::NewProp_In = { "In", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCitySampleAnimNode_CopyPoseRotations, In), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_In_MetaData), NewProp_In_MetaData) }; // 1074011079
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCitySampleAnimNode_CopyPoseRotations_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_CitySample,
...
UScriptStruct* Z_Construct_UScriptStruct_FCitySampleAnimNode_CopyPoseRotations()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_CitySampleAnimNode_CopyPoseRotations.InnerSingleton, Z_Construct_UScriptStruct_FCitySampleAnimNode_CopyPoseRotations_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_CitySampleAnimNode_CopyPoseRotations.InnerSingleton;
}
// End ScriptStruct FCitySampleAnimNode_CopyPoseRotations

// Begin Registration
struct Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Anim_CitySampleAnimNode_CopyPoseRotations_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCitySample_BoneSourceToTargetMapping::StaticStruct, Z_Construct_UScriptStruct_FCitySample_BoneSourceToTargetMapping_Statics::NewStructOps, TEXT("CitySample_BoneSourceToTargetMapping"), &Z_Registration_Info_UScriptStruct_CitySample_BoneSourceToTargetMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCitySample_BoneSourceToTargetMapping), 1670337526U) },
		{ FCitySampleAnimNode_CopyPoseRotations::StaticStruct, Z_Construct_UScriptStruct_FCitySampleAnimNode_CopyPoseRotations_Statics::NewStructOps, TEXT("CitySampleAnimNode_CopyPoseRotations"), &Z_Registration_Info_UScriptStruct_CitySampleAnimNode_CopyPoseRotations, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCitySampleAnimNode_CopyPoseRotations), 3561205327U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Anim_CitySampleAnimNode_CopyPoseRotations_h_938595806(TEXT("/Script/CitySample"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Anim_CitySampleAnimNode_CopyPoseRotations_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_lyracity_5_4_Plugins_CitySample_Source_CitySample_Public_Anim_CitySampleAnimNode_CopyPoseRotations_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
